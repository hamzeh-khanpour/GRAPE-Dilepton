...
* Particle name
      kmprtc(kperm(1)) = 's-bar'
      kmprtl(kperm(1)) = 5
      kmprtc(kperm(2)) = 'positron'
      kmprtl(kperm(2)) = 8
      kmprtc(kperm(3)) = 's-bar'
      kmprtl(kperm(3)) = 5
      kmprtc(kperm(4)) = 'positron'
      kmprtl(kperm(4)) = 8
      kmprtc(kperm(5)) = 'electron'
      kmprtl(kperm(5)) = 8
      kmprtc(kperm(6)) = 'positron'
      kmprtl(kperm(6)) = 8

* Masses of external particles
      amass1(kperm(1)) = amdq(2)
      amass1(kperm(2)) = amlp(1)
      amass1(kperm(3)) = amdq(2)
      amass1(kperm(4)) = amlp(1)
      amass1(kperm(5)) = amlp(1)
      amass1(kperm(6)) = amlp(1)
